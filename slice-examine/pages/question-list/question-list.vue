<template>
	<view style="width:100%;">
		<view class="question-tab-main">
			<view>
				<mSearch :mode="2" button="inside" :show='false'></mSearch>
			</view>
			<view class="calendar-color-beizhu">
				<view class="color-beizhu-list">
					<view>
						...
						<!-- <view class="bg-yellow beizhu-padding"></view> -->
					</view>
					<view>
						<text>审核失败：</text>
		...
		<view style="width:100%;height:250upx;"></view>
