...
public class ShopUserAuths {
    ...
    /**
     * 用户可登陆权限表主键id
     * @return user_auths_id 用户可登陆权限表主键id
     */
    public Integer getUserAuthsId() {
        return userAuthsId;
    }

    /**
     * 用户可登陆权限表主键id
     * @param userAuthsId 用户可登陆权限表主键id
     */
    public void setUserAuthsId(Integer userAuthsId) {
